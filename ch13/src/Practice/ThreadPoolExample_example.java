 ...
 * </pre>
 */
public class ThreadPoolExample_example
{
	public static void main(String[] args)
	{
		...
		for(int i=0; i<customerList.size(); i++) {
			executorService.execute(new Calculate_example(customerList.get(i)));
		}
...
class Calculate_example implements Runnable
{
	int 	cashier 	= 0;
	String 	customer 	= null;
	
	Calculate_example(String customer)
	{
