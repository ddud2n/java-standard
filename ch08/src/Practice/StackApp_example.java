...
class StringStack_example implements Stack_example {

	String[] strArr;		// String 배열
	int cnt = 0;			// 배열에 들어있는 항목의 개수
	
	StringStack_example(int size) {
...
class StackApp_example {
	public static void main(String[] args) {
		...
		StringStack_example stack = new StringStack_example(size);
