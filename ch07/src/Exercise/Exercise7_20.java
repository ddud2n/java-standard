...
class Exercise7_20 {
	public static void main(String args[]) {
		...
		System.out.println("p.x = " + p.x);		// Parent의 멤버변수 x = 100 출력
		p.method();								// 처음에 Parent의 메서드를 찾았다가, 오버라이딩된 Child의 메서드 내용 = "Child Method" 출력
		
		System.out.println("c.x = " + c.x);		// Child의 멤버 x = 200 출력
		c.method();								// Child의 메서드 내용 = "Child Method" 출력
	}
}
